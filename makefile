...
build-test: test.o utils.o lexer.o parser.o hashMap_str_enum.o str_list.o
	$(CC) lib/tests.o lib/utils.o lib/lexer.o lib/parser.o lib/hashMap_str_enum.o lib/str_list.o -o build/tests
...
test.o: test/tests.c \
		...
		src/data_structures/hashMap_str_enum.h
...
hashMap_str_enum.o: src/data_structures/hashMap_str_enum.c src/data_structures/hashMap_str_enum.h src/utils.h
